...
parser.add_argument('--lbda', default='2048')
...
def testuvg(global_step, testfull=False):
    with torch.no_grad():
        ...
        logger.info(log)
        uvgdrawplt([sumbpp], [sumpsnr], [summsssim], args.lbda, testfull=testfull)
...
if __name__ == "__main__":
    ...
    train_dataset = DataSet("../db/vimeo/vimeo_septuplet/test.txt")
